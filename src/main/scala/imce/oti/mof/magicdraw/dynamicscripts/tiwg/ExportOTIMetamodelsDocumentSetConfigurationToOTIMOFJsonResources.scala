...
object ExportOTIMetamodelsDocumentSetConfigurationToOTIMOFJsonResources {
    ...
    = {
      ...
      otiCheck match {
        ...
        case Success(_) =>
          ...
          def f
          (acc: Vector[java.lang.Throwable] \&/ Vector[OTIMOFMetamodelTables],
          ...
          = {
            ...
            = odsa.ds.lookupDocumentByScope(pkg) match {
              ...
              case Some(d) =>
                ExportAsOTIMOFMetamodels
                  .exportAsOTIMOFMetamodelTables(p, odsa, d, pkg)
          ...
          val metamodelExtents
          : Vector[java.lang.Throwable] \&/ Vector[OTIMOFMetamodelTables]
          = selectedPackages.aggregate[Vector[java.lang.Throwable] \&/ Vector[OTIMOFMetamodelTables]](
            \&/.That(Vector.empty)
          )(f, _ append _)
          ...
          = metamodelExtents.a.getOrElse(Vector.empty[java.lang.Throwable])
